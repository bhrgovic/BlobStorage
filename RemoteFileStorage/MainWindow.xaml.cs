...
namespace RemoteFileStorage
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private async void BtnUpload_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                Filter = "Image Files(*.JPEG;*.JPG;*.TIFF;*.PNG;*.SVG;*.GIF)|*.JPEG;*.JPG;*.TIFF;*.PNG;*.SVG;*.GIF"
            };
            if (openFileDialog.ShowDialog() == true)
            {
                await itemsViewModel.UploadAsync(openFileDialog.FileName, System.IO.Path.GetExtension(openFileDialog.FileName));
            }
